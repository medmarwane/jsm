      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        {(type === "remove" || type === "recolor") && (
          <div className="prompt-filed">
            <CustomField control={form.control} name="prompt" formLabel={type === "remove" ? "Object to remove" : "Object to recolor"} className="w-full" render={({ field }) => <Input className="input-field" value={field.value} onChange={e => onInputChangeHandler("prompt", e.target.value, type, field.onChange)} />} />
