  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex-between">
        ...
        {hasDownload && (
          <button className="download-btn" title="Download" onClick={downloadHandler}>
            <Image src="/assets/icons/download.svg" alt="Download" width={24} height={24} className="pd-[6px]" />
          </button>
        )}
      </div>
